...
<style>
    ...
    /* pengaturan untuk navbar, menambahkan margin untuk opsi di kiri atas */
    .navbar-nav {
        margin-left: 20px; /* memberi jarak antara tulisan Laravel dan opsi di navbar */
    }

    .navbar-nav li {
        margin-right: 15px; /* memberi jarak antar opsi */
    }
